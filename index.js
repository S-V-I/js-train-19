...
// ScienceBook.info = "newValue";
// console.log(ScienceBook.info);

// Зробимо щоб 'info' не можна було видалити або змінити, перевіримо і спробуємо
// присвоїти ій будь яке значення (це потрібно робити ззовні defineProperty),
...
// при виклику, помилку більше не отримуємо але при спробі вивести значення info
// отримуємо undefined
...
const descriptor = Object.getOwnPropertyDescriptor(ScienceBook, "info");
...
const Media = {
  ...
  length: 0,
  play: function () {
    console.log(`Зараз відтворюється медіа у форматі ${this.format} 
    з тривалістю ${this.length} секунд`);
  },
};
